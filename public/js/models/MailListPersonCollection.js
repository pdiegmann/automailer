define(['models/MailList'], function(MailList) {
	var MailListItemCollection = Backbone.PageableCollection.extend({
		model: MailList,
		url: '/dataset/' + (this.attributes && this.attributes.dataset ? this.attributes.dataset : "") + '/mail/list/' + (this.attributes && this.attributes.maillistid ? this.attributes.maillistid : "") + "/persons",
